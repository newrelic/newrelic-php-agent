...
release-installer-script: bin/newrelic-install bin/newrelic-install-php-cfg-mappings.php bin/newrelic-install-inject-envvars.php | releases/$(RELEASE_OS)/
	cp bin/newrelic-install releases/$(RELEASE_OS)
	cp bin/newrelic-install-inject-envvars.php releases/$(RELEASE_OS)
	cp bin/newrelic-install-php-cfg-mappings.php releases/$(RELEASE_OS)
