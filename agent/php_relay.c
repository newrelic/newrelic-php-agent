...
#include "php_relay_private.h"
#include "util_system.h"

const uint16_t nr_php_relay_default_port = 6379;

nr_datastore_instance_t* nr_php_relay_create_datastore_instance(
...
nr_datastore_instance_t* nr_php_relay_save_datastore_instance(
  ...
  key = nr_php_datastore_make_key(relay_conn, "relay");
  instance = nr_php_relay_create_datastore_instance(host_or_socket, port);
...
nr_datastore_instance_t* nr_php_relay_retrieve_datastore_instance(
...
void nr_php_relay_remove_datastore_instance(const zval* relay_conn TSRMLS_DC) {
  char* key;
