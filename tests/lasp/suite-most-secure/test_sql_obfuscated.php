...
/*DESCRIPTION
Tests the agent sends no sql statement in transaction traces when the Language Agent
Security Policy (LASP) configuration indicates record_sql:{enabled:false}, but the agent
is configured to send obfuscated SQL.
*/
