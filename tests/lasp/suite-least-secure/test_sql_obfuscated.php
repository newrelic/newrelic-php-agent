...
/*DESCRIPTION
Tests the agent sends a sql statement in the transaction traces when the Language Agent
Security Policy (LASP) configuration indicates record_sql:{enabled:true}, and agent
