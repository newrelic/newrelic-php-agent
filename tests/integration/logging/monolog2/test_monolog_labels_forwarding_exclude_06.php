...
Test that Monolog2 instrumentation can forward logs with labels when:
  ...
  - label exclusion set to "label1,  ,,,,    label3,  "

This tests that commas and spaces are handled properly when parsing the exclusion list.

Expect:
  - tags2.label2 will to be added to common attributes for log event harvest
...
newrelic.application_logging.forwarding.labels.exclude = "label1,  ,,,,    label3,  "
