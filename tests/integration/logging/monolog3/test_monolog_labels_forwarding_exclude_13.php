...
Test that Monolog3 instrumentation can forward logs with labels when:
  ...
  - newrelic.labels set to "LaBel1:VaLue1;label1:VALUE2; LABEL1:value3"
  - label exclusion rule set to "label1"

This test makes sure that the exclude rule is applied case-insensitively.

Expect:
  - No tags will be added to common attributes for log event harvest
...
newrelic.labels = "LaBel1:VaLue1;label1:VALUE2; LABEL1:value3"
*/
