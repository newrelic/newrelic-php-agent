...
Test that Monolog3 instrumentation can forward logs with labels when:
  ...
  - newrelic.labels set to "label1: from newrelic.ini"
  - NEW_RELIC_LABELS set to "label2: from NEW_RELIC_LABELS"
  - NEW_RELIC_LABEL_label3 set to "from NEW_RELIC_LABEL_label3"
  - default label exclusion rule

This tests that the agent combines labels from multiple sources when forwarding with log events.
This tests that spaces are preserved in label values.

Expect:
  - tags.label1, tags.label2, and tags.label3 to be added to common attributes for log event harvest
...
newrelic.labels = "label1: from newrelic.ini"
*/

/*ENVIRONMENT
NEW_RELIC_LABELS=label2: from NEW_RELIC_LABELS
NEW_RELIC_LABEL_label3=from NEW_RELIC_LABEL_label3
*/
...
[
    {
      "common": {
        "attributes": {
          "tags.label1": "from newrelic.ini",
          "tags.label2": "from NEW_RELIC_LABELS",
          "tags.label3": "from NEW_RELIC_LABEL_label3"
        }
      },
      "logs": [
        {
