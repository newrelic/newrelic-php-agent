...
Test that Monolog3 instrumentation can forward logs with labels when:
  ...
  - label exclusion set to "label2, LaBeL3"

This tests that the exclusion list is implemented with case-insensitive matching.

Expect:
  - tags.label1 and tags2.label2 will to be added to common attributes for log event harvest
...
newrelic.application_logging.forwarding.labels.exclude = "label2, LaBeL3"
