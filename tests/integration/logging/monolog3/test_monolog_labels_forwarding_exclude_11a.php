...
Test that Monolog3 instrumentation can forward logs with labels when:
  ...
  - exclusion rule set to "l a b e l 2"
...
Expect:
  - tags.label1 to be added to common attributes for log event harvest
...
newrelic.application_logging.forwarding.labels.exclude = "l a b e l 2"
...
[
    {
      "common": {
        "attributes": {
          "tags.label  1": "from newrelic.ini"
        }
      },
      "logs": [
        {
