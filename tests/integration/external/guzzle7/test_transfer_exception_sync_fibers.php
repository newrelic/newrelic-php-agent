...
/*DESCRIPTION
Test that the span for a sync external request that ends up throwing TransferException exception
...
function test_sync_transfer_exception() {
...
$fiber = new Fiber('test_sync_transfer_exception');
$fiber->start();
$fiber->resume();
$fiber->resume();
