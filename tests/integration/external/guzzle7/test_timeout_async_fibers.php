...
/*DESCRIPTION
Test that the span for an async external request that times out is marked as http and uri is captured. Status code is marked as 0. Using Fibers.
*/
...
$fiber = new Fiber('test_timeout_async');
$fiber->start();
$fiber->resume();
$fiber->resume();
