...
[
  ...
  "?? stop time",
  [
    [{"name":"DurationByCaller/App/33/5043/HTTPS/all"},
                                                          [1, "??", "??", "??", "??", "??"]],
    [{"name":"DurationByCaller/App/33/5043/HTTPS/allOther"},
                                                          [1, "??", "??", "??", "??", "??"]],
    ...
    [{"name":"Supportability/api/accept_distributed_trace_headers"},
                                                          [1, "??", "??", "??", "??", "??"]],
    [{"name":"TransportDuration/App/33/5043/HTTPS/all"},
                                                          [1, "??", "??", "??", "??", "??"]],
    [{"name":"TransportDuration/App/33/5043/HTTPS/allOther"},
                                                          [1, "??", "??", "??", "??", "??"]]
  ]
]
*/
