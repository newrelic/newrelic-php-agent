...
/*DESCRIPTION
The agent should record Datastore metrics for PDO query operations if fibers are involved.
*/
    ...
    [
      {
        ...
        "traceId": "??",
        "transactionId": "??",
        "name": "Datastore\/statement\/Postgres\/test\/create",
        "timestamp": "??",
        "duration": "??",
        "priority": "??",
        "sampled": true,
    ...
    [
      {
        ...
        "traceId": "??",
        "transactionId": "??",
        "name": "Datastore\/statement\/Postgres\/test\/insert",
        "timestamp": "??",
        "duration": "??",
        "priority": "??",
        "sampled": true,
    ...
    [
      {
        ...
        "traceId": "??",
        "transactionId": "??",
        "name": "Datastore\/statement\/Postgres\/test\/select",
        "timestamp": "??",
        "duration": "??",
        "priority": "??",
        "sampled": true,
    ...
    [
      {
        ...
        "traceId": "??",
        "transactionId": "??",
        "name": "Datastore\/statement\/Postgres\/test\/drop",
        "timestamp": "??",
        "duration": "??",
        "priority": "??",
        "sampled": true,
...
require_once(realpath(dirname(__FILE__)) . '/../../test_query_fetch_class.inc');
...
$fiber_pdo->start(new PDO($PDO_PGSQL_DSN, $PG_USER, $PG_PW), 0, true);
$fiber_a->start();
$fiber_pdo->resume();
$fiber_a->resume();
$fiber_pdo->resume();
