...
/*DESCRIPTION
The agent should report Redis metrics and spans for Redis basic operations if fibers are involved.
*/
...
[
  ...
  [
    ...
    [{"name":"Datastore/instance/Redis/redisdb/6379"},                ["??", "??", "??", "??", "??", "??"]]
  ]
]
*/
...
[
  ...
  [
    ...
    [
      ...
      {},
      {
        "peer.hostname": "redisdb",
        "peer.address": "redisdb:6379",
        "db.instance": "0"
      }
    ],
    [
...
$fiber_a = new Fiber('a');
$fiber_basic = new Fiber('test_basic');
