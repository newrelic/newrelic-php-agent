...
/*DESCRIPTION
Tests newrelic_set_error_group_callback() API handling when a user callback returns a numerical value instead of a non-empty string.
...
file => /usr/src/myapp/tests/integration/api/error_group_callback/test_error_group_callback_bad_return_num.php
stack => [" in alpha called at \/usr\/src\/myapp\/tests\/integration\/api\/error_group_callback\/test_error_group_callback_bad_return_num.php (134)"]
*/
