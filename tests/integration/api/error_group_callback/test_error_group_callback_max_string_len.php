...
/*DESCRIPTION
Tests newrelic_set_error_group_callback() API when the returned string is greater than the max (255) number of characters.

When a user error group callback returns a string longer than 255 characters, 
the Agent will strip the excess characters.
*/
...
[
  ...
  [
    [
      ...
      {},
      {
        "error.group.name": "TheFitnessGramPacerTestIsAMultistageAerobicCapacityTestThatProgressivelyGetsMoreDifficultAsItContinuesThe20MeterPacerTestWillBeginIn30SecondsLineUpAtTheStartTheRunningSpeedStartsSlowlyButGetsFasterEachMinuteAfterYouHearThisSignalBeepASingleLapShouldBeComp"
      }
    ]
  ]
]
...
$callback = function($txndata, $errdata) 
{
  ...
  $fingerprint = "";
  return $fingerprint;
};
