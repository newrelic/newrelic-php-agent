...
/*DESCRIPTION
Test that attributes are added to span events even if transaction_events are
off.  Attribute keys should be limited to 255 bytes (256 including the null
terminator), but if an attribute key exceeds 255 bytes, then the attribute
should be dropped.  If the dropped attribute was a custom attribute, then a
...
function a() {
  tap_assert(newrelic_add_custom_span_parameter("string", ""), "string attribute added");
