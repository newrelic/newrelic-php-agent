...
/*DESCRIPTION
Test that attributes are added to span events with transaction_events disabled.
If the transaction event has an attribute with the same name as the currently
...
function a() {
  ...
  tap_assert(newrelic_add_custom_span_parameter("bool", true), "bool attribute added");
  tap_assert(newrelic_add_custom_span_parameter("double", 2.5), "double attribute added");
